...
```bash
/home/cszcm/web/Audioteca/.venv/bin/python tools/import_podcast_feed.py --dry-run
```

Crear Markdown y descargar los MP3 a `assets/mp3/` (ejemplo con 5 episodios):

```bash
/home/cszcm/web/Audioteca/.venv/bin/python tools/import_podcast_feed.py --download --limit 5
```
